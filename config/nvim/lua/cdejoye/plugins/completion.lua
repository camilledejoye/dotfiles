...
return {
  ...
  -- I can try to lazy load because I'll load the extra capabilities when setting up LSP
  -- So, worst case, it's loaded when LSP is setup instead of on those events
