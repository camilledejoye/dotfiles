...
local on_attach = function(_, bufnr)
  ...
  buf_set_keymap('n', '<C-w><C-]>', [[<cmd>lua cdejoye.lsp.buf.definition('vsplit')<CR>]], opts)
  buf_set_keymap('n', '<C-A-]>', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
  buf_set_keymap('n', '<C-w><C-A-]>', [[<cmd>lua cdejoye.lsp.buf.type_definition('vsplit')<CR>]], opts)
  buf_set_keymap('n', 'gdd', '<cmd>lua vim.lsp.buf.definition()<CR>', opts)
  buf_set_keymap('n', 'gdD', [[<cmd>lua cdejoye.lsp.buf.definition('vsplit')<CR>]], opts)
  buf_set_keymap('n', 'gdi', '<cmd>lua vim.lsp.buf.implementation()<CR>', opts)
  buf_set_keymap('n', 'gdI', [[<cmd>lua cdejoye.lsp.buf.implementation('vsplit')<CR>]], opts)
  buf_set_keymap('n', 'gdt', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
  buf_set_keymap('n', 'gdT', [[<cmd>lua cdejoye.lsp.buf.type_definition('vsplit')<CR>]], opts)
  buf_set_keymap('n', 'gdr', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
  buf_set_keymap('n', 'gdR', [[<cmd>lua cdejoye.lsp.buf.references('vsplit')<CR>]], opts)
